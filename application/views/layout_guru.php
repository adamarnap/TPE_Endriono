          ...
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
               <a href="<?php echo site_url('user/dashboard_guru');?>" class="nav-link"><h3>Dashboard</h3></a>
                <ul class="nav side-menu">
                  <li><a href="<?php echo site_url('user_guru/userguru');?>"><i class="fa fa-edit"></i> Materi</a></li>
                  <li><a href="<?php echo site_url('user_guru/userguru_ujian');?>"><i class="fa fa-file-excel-o"></i> Ujian </a></li>
                  <li><a href="<?php echo site_url('user_guru/userguru_jwbujian');?>"><i class="fa fa-table"></i>Jawaban Ujian </a></li>
                  <li><a href="<?php echo site_url('user_guru/userguru_nilai');?>"><i class="fa fa-desktop"></i> Nilai</a></li>
                </ul>
              </div>
            </div>
            <!-- /sidebar menu -->
